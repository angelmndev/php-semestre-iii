    ...
    <div class="col">
        <form action="">
            ...
            <div class="form-group">
                <samp class="titulo_detalles">Cantidad entrada:</samp>
                <input type="text" class="form-control text_cantidad_salida" id="txt_cantidad_entrada" placeholder="Cantidad entrada">
