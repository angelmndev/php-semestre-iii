        ...
        <div class="col">
            <div class="form-group">
                ...
                <select class="form-control text_usuario" name="" id="cb_nombre">
                    ...
                    while ($fila = $datos->fetch_array(MYSQLI_ASSOC)) {
                        ?>
                    <option value="<?=$fila['pk_producto'] ?>"><?= $fila['nombre'] ?></option>
                    <?php
                    } //end while
                    ?>
                </select>
            ...
            <div class="form-group contenedor_input">
                ...
                <?php 
                    $obj = new Categoria();
                    $datos = $obj->listar(); 
                    while($filaCat=$datos->fetch_array(MYSQLI_ASSOC)){
                    ?>
                    <option value="<?=$filaCat['pk_categoria']?>" ><?=$filaCat['categoria']?></option>
                    <?php
                    }//end while
                    ?>
                </select>
