...
<table  id="tb_lista" class="table table-striped table-dark">
  ...
  ?>
  <tbody>
    <tr onClick="pasar_pk_registro(<?= $fila['pk_salida'] ?>);ver_detalle();">
      ...
      <td><?=$fila['fecha']?></td>
      <td><?=$fila['stock']?></td>
      <td class="col_center"><button class="btn-light btn-detalle-entrada" onclick="ver_detalle_salida();"><i class="fas fa-eye"></i></button></td>
    </tr>
  </tbody>
